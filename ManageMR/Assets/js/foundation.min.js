    ...
    var s = "6.0.6"
      , o = {
        ...
        registerPlugin: function(t) {
            var i = e(t.constructor).toLowerCase();
            t.uuid = this.GetYoDigits(6, i),
            t.$element.attr("data-" + i) || t.$element.attr("data-" + i, t.uuid),
            t.$element.trigger("init.zf." + i),
            this._activePlugins[t.uuid] = t
        },
        unregisterPlugin: function(t) {
            var i = e(t.constructor).toLowerCase();
            delete this._activePlugins[t.uuid],
            t.$element.removeAttr("data-" + i).trigger("destroyed.zf." + i)
        },
        _reflow: function(t) {
            var e = Object.keys(this._activePlugins)
              , i = this;
            if (t) {
                if ("string" == typeof t) {
                    var n = t.split("-")[1];
                    n ? this._activePlugins[t]._init() : (n = new RegExp(t,"i"),
                    e.filter(function(t) {
                        return n.test(t)
                    }).forEach(function(t) {
                        i._activePlugins[t]._init()
                    }))
                }
            } else
        ...
        reflow: function(e, n) {
            ...
            t.each(n, function(n, o) {
                ...
                r.each(function() {
                    ...
                    try {
                        e.data("zf-plugin", new a(t(this),n))
                    } catch (s) {
                        console.error(s)
                    } finally {
                        return
...
!function(t, e) {
    var i = function(t, e, i, s) {
        ...
        if (e) {
            var h = n(e);
            a = d.offset.top + d.height <= h.height + h.offset.top,
            o = d.offset.top >= h.offset.top,
            r = d.offset.left >= h.offset.left,
            l = d.offset.left + d.width <= h.width
        } else
...
!function(t, e) {
    ...
    var o = {}
      , a = function(i, n, a) {
        var r, l, d, h = o[e.getFnName(n)], u = s(i);
        return h ? (r = "undefined" == typeof h.ltr ? h : e.rtl() ? t.extend({}, h.ltr, h.rtl) : t.extend({}, h.rtl, h.ltr),
        l = r[u],
        d = a[l],
        void (d && "function" == typeof d ? (d.apply(n),
        (a.handled || "function" == typeof a.handled) && a.handled.apply(n)) : (a.unhandled || "function" == typeof a.unhandled) && a.unhandled.apply(n))) : console.warn("Component not defined!")
    };
    ...
    var n = {
        ...
        _watcher: function() {
            ...
            t(window).on("resize.zf.mediaquery", function() {
                ...
                i !== e.current && (t(window).trigger("changed.zf.mediaquery", [i, e.current]),
                e.current = i)
            })
        }
    };
...
function(t) {
    ...
    function i(i) {
        ...
        d) {
            var n, s = i.touches[0].pageX, h = i.touches[0].pageY, u = o - s, c = a - h;
            l = (new Date).getTime() - r,
            Math.abs(u) >= t.spotSwipe.moveThreshold && l <= t.spotSwipe.timeThreshold ? n = u > 0 ? "left" : "right" : Math.abs(c) >= t.spotSwipe.moveThreshold && l <= t.spotSwipe.timeThreshold && (n = c > 0 ? "down" : "up"),
            n && (e.call(this),
...
!function(t) {
    t.fn.addTouch = function() {
        ...
        var e = function(t) {
            ...
            o.initMouseEvent(s, !0, !0, window, 1, i.screenX, i.screenY, i.clientX, i.clientY, !1, !1, !1, !1, 0, null),
...
!function(t, e) {
    ...
    i.defaults = {
        ...
        validators: {
            equalTo: function(t, e, i) {
                var n = document.getElementById(t.getAttribute(this.add_namespace("data-equalto"))).value
                  , s = t.value
                  , o = n === s;
                return o
            }
    ...
    i.prototype._events = function() {
        var t = this;
        this.$element.off(".abide").on("reset.fndtn.abide", function(i) {
            t.resetForm(e(this))
        }).on("submit.fndtn.abide", function(e) {
            e.preventDefault(),
            t.validateForm(t.$element)
        }).find("input, textarea, select").off(".abide").on("blur.fndtn.abide change.fndtn.abide", function(i) {
            "fieldChange" === t.options.validateOn && t.validateInput(e(i.target), t.$element)
    ...
    i.prototype.requiredCheck = function(t) {
        switch (t[0].type) {
        case "text":
            return t.attr("required") && !t.val() ? !1 : !0;
        case "password":
            return t.attr("required") && !t.val() ? !1 : !0;
        case "checkbox":
            return t.attr("required") && !t.is(":checked") ? !1 : !0;
        case "radio":
            return t.attr("required") && !t.is(":checked") ? !1 : !0;
        default:
            return !t.attr("required") || t.val() && t.val().length && !t.is(":empty") ? !0 : !1
        }
    }
    ,
    i.prototype.findLabel = function(t) {
        return t.next("label").length ? t.next("label") : t.closest("label")
    }
    ,
    i.prototype.addErrorClasses = function(t) {
        var e = this
          , i = e.findLabel(t)
          , n = t.next(e.options.formErrorSelector) || t.find(e.options.formErrorSelector);
        i && i.addClass(e.options.labelErrorClass),
        n && n.addClass(e.options.formErrorClass),
        t.addClass(e.options.inputErrorClass)
    }
    ,
    i.prototype.removeErrorClasses = function(t) {
        var e = this
          , i = e.findLabel(t)
          , n = t.next(e.options.formErrorSelector) || t.find(e.options.formErrorSelector);
        i && i.hasClass(e.options.labelErrorClass) && i.removeClass(e.options.labelErrorClass),
        n && n.hasClass(e.options.formErrorClass) && n.removeClass(e.options.formErrorClass),
        t.hasClass(e.options.inputErrorClass) && t.removeClass(e.options.inputErrorClass)
    }
    ,
    i.prototype.validateInput = function(t, i) {
        var n, s, o = this;
        i.find('input[type="text"]'),
        i.find('input[type="password"]'),
        i.find('input[type="checkbox"]');
        "text" === t[0].type ? o.requiredCheck(t) && o.validateText(t) ? (o.removeErrorClasses(t),
        t.trigger("valid.fndtn.abide", t[0])) : (o.addErrorClasses(t),
        t.trigger("invalid.fndtn.abide", t[0])) : "radio" === t[0].type ? (s = t.attr("name"),
        n = t.siblings("label"),
        o.validateRadio(s) ? (e(n).each(function() {
            e(this).hasClass(o.options.labelErrorClass) && e(this).removeClass(o.options.labelErrorClass)
        }),
        t.trigger("valid.fndtn.abide", t[0])) : (e(n).each(function() {
            e(this).addClass(o.options.labelErrorClass)
        }),
        t.trigger("invalid.fndtn.abide", t[0]))) : "checkbox" === t[0].type ? o.requiredCheck(t) ? (o.removeErrorClasses(t),
        t.trigger("valid.fndtn.abide", t[0])) : (o.addErrorClasses(t),
        t.trigger("invalid.fndtn.abide", t[0])) : o.requiredCheck(t) && o.validateText(t) ? (o.removeErrorClasses(t),
        t.trigger("valid.fndtn.abide", t[0])) : (o.addErrorClasses(t),
        t.trigger("invalid.fndtn.abide", t[0]))
    }
    ,
    i.prototype.validateForm = function(t) {
        for (var i = this, n = t.find("input"), s = t.find("input").length, o = 0; s > o; )
            i.validateInput(e(n[o]), t),
            o++;
        t.find(".form-error.is-visible").length || t.find(".is-invalid-label").length ? t.find("[data-abide-error]").css("display", "block") : t.find("[data-abide-error]").css("display", "none")
    }
    ,
    i.prototype.validateText = function(t) {
        var i = this.options.patterns
          , n = e(t).val()
          , s = e(t).attr("pattern");
        return 0 === n.length ? !0 : n.match(i[s]) ? !0 : !1
    }
    ,
    i.prototype.validateRadio = function(t) {
        var i = this
          , n = (e(':radio[name="' + t + '"]').siblings("label"),
        0);
        return e(':radio[name="' + t + '"]').each(function() {
            i.requiredCheck(e(this)) || n++,
            e(this).is(":checked") && (n = 0)
        }),
        n > 0 ? !1 : !0
    }
    ,
    i.prototype.matchValidation = function(t, e) {}
    ,
    i.prototype.resetForm = function(t) {
        var i = this
          , n = "data-invalid";
        e("[" + i.invalidAttr + "]", t).removeAttr(n),
        e("." + i.options.labelErrorClass, t).not("small").removeClass(i.options.labelErrorClass),
        e("." + i.options.inputErrorClass, t).not("small").removeClass(i.options.inputErrorClass),
        e(".form-error.is-visible").removeClass("is-visible"),
        t.find("[data-abide-error]").css("display", "none"),
        e(":input", t).not(":button, :submit, :reset, :hidden, [data-abide-ignore]").val("").removeAttr(n)
    }
    ,
...
!function(t, e) {
    ...
    i.prototype._events = function() {
        ...
        this.$tabs.each(function() {
            ...
            s.length && n.children("a").off("click.zf.accordion keydown.zf.accordion").on("click.zf.accordion", function(t) {
                t.preventDefault(),
                n.hasClass("is-active") ? (i.options.allowAllClosed || n.siblings().hasClass("is-active")) && i.up(s) : i.down(s)
            }).on("keydown.zf.accordion", function(t) {
                e.Keyboard.handleKey(t, i, {
                    toggle: function() {
                        i.toggle(s)
                    },
                    next: function() {
    ...
    i.prototype.up = function(e) {
        ...
        (this.options.allowAllClosed || s) && (e.slideUp(n.options.slideSpeed),
    ...
    e.prototype._events = function() {
        ...
        this.$element.find("li").each(function() {
            ...
            a.each(function(e) {
                ...
                void (t(this).is(":last-child") && (s = o.parents("li").first().next("li")))) : void 0
            }),
            Foundation.Keyboard.handleKey(i, e, {
                open: function() {
                    r.is(":hidden") && (e.down(r),
                    r.find("li").first().focus())
                },
                close: function() {
                    r.length && !r.is(":hidden") ? e.up(r) : o.parent("[data-submenu]").length && (e.up(o.parent("[data-submenu]")),
                    o.parents("li").first().focus())
                },
                up: function() {
                    n.focus()
                },
...
!function(t, e) {
    ...
    i.prototype._prepareMenu = function() {
        ...
        this.$element.parent().hasClass("is-drilldown") || (this.$wrapper = t(this.options.wrapper).addClass("is-drilldown").css(this._getMaxDims()),
    ...
    i.prototype._keyboardEvents = function() {
        ...
        this.$menuItems.add(this.$element.find(".js-drilldown-back")).on("keydown.zf.drilldown", function(n) {
            ...
            r.each(function(e) {
                return t(this).is(a) ? (s = r.eq(Math.max(0, e - 1)),
                void (o = r.eq(Math.min(e + 1, r.length - 1)))) : void 0
            }),
            e.Keyboard.handleKey(n, i, {
                next: function() {
                ...
                open: function() {
                    a.is(i.$menuItems) ? a.is(i.$submenuAnchors) && (i._show(a),
                    setTimeout(function() {
                        a.find("ul li").filter(i.$menuItems).first().focus()
                    }, 1)) : (i._hide(a.parent("ul")),
                    setTimeout(function() {
                        a.parent("ul").parent("li").focus()
                    }, 1))
                },
...
!function(t, e) {
    ...
    i.prototype._setPosition = function() {
        ...
        var t = this.getPositionClass()
          ...
          , n = (e.Box.GetDimensions(this.$anchor),
        ...
        if (i.width >= i.windowDims.width || !this.counter && !e.Box.ImNotTouchingYou(this.$element))
            return this.$element.offset(e.Box.GetOffsets(this.$element, this.$anchor, "center bottom", this.options.vOffset, this.options.hOffset, !0)).css({
                width: i.windowDims.width - 2 * this.options.hOffset,
                height: "auto"
            }),
            this.classChanged = !0,
            !1;
        for (this.$element.offset(e.Box.GetOffsets(this.$element, this.$anchor, t, this.options.vOffset, this.options.hOffset)); !e.Box.ImNotTouchingYou(this.$element) && this.counter; )
            this._reposition(t),
            this._setPosition()
    }
    ,
        ...
        this.$anchor.add(this.$element).on("keydown.zf.dropdown", function(n) {
            ...
            e.Keyboard.handleKey(n, i, {
                tab_forward: function() {
                    this.$element.find(":focus").is(o.eq(-1)) && (this.options.trapFocus ? (o.eq(0).focus(),
                    n.preventDefault()) : this.close())
                },
                tab_backward: function() {
                    (this.$element.find(":focus").is(o.eq(0)) || this.$element.is(":focus")) && (this.options.trapFocus ? (o.eq(-1).focus(),
                    n.preventDefault()) : this.close())
                },
                open: function() {
                    s.is(i.$anchor) && (i.open(),
                    i.$element.attr("tabindex", -1).focus(),
                    n.preventDefault())
                },
                close: function() {
                    i.close(),
...
!function(t, e) {
    ...
    function i(n, s) {
        ...
        this._init(),
        e.registerPlugin(this),
        e.Keyboard.register("DropdownMenu", {
            ENTER: "open",
            SPACE: "open",
            ARROW_RIGHT: "next",
            ARROW_UP: "up",
    ...
    i.prototype._init = function() {
        ...
        this.$element.hasClass(this.options.rightClass) || "right" === this.options.alignment ? (this.options.alignment = "right",
        t.addClass("is-left-arrow opens-left")) : t.addClass("is-right-arrow opens-right"),
    ...
    i.prototype._events = function() {
        ...
        (this.options.clickOpen || s) && this.$menuItems.on("click.zf.dropdownmenu touchstart.zf.dropdownmenu", function(e) {
            ...
            if (a)
                if (r) {
                    if (!n.options.closeOnClick || !n.options.clickOpen && !s || n.options.forceFollow && s)
                        return;
                    ...
                    i.add(i.parentsUntil(n.$element, "." + o)).attr("data-is-click", !0)
        }),
        this.options.disableHover || this.$menuItems.on("mouseenter.zf.dropdownmenu", function(e) {
            ...
            if (a && n.options.autoclose) {
                if ("true" === s.attr("data-is-click") && n.options.clickOpen)
                    return !1;
                i = setTimeout(function() {
                    n._hide(s)
        ...
        this.$menuItems.on("keydown.zf.dropdownmenu", function(i) {
            ...
            l.each(function(e) {
                return t(this).is(a) ? (s = l.eq(e - 1),
                void (o = l.eq(e + 1))) : void 0
            });
            var d = function() {
              ...
              , f = {
                ...
                close: function() {
                    n._hide(n.$element),
                    n.$menuItems.find("a:first").focus()
                },
                handled: function() {
                    i.preventDefault(),
                    i.stopImmediatePropagation()
            ...
            r ? n.vertical ? "left" === n.options.alignment ? t.extend(f, {
                down: d,
                up: h,
                next: u,
                previous: c
                ...
                down: u,
                up: c
            }) : "left" === n.options.alignment ? t.extend(f, {
                next: u,
                previous: c,
                down: d,
                up: h
    ...
    i.prototype._show = function(i) {
        ...
        if (!o) {
            ...
            o = e.Box.ImNotTouchingYou(i, null, !0),
            o || r.removeClass("opens-" + this.options.alignment).addClass("opens-inner"),
            this.changed = !0
        }
        i.css("visibility", ""),
...
!function(t, e) {
    ...
    i.prototype._events = function() {
        var e = this;
        this.$window.off(".equalizer").on("resize.fndtn.equalizer", t.util.throttle(function() {
            e._reflow()
    ...
    i.prototype._reflow = function() {
        ...
        e("[" + this.attr + "]").each(function() {
            var n = e(this)
              , s = []
              , o = n.find("img");
            o.length ? t.onImagesLoaded(o, function() {
                s = i.getHeights(n),
                i.applyHeight(n, s)
            }) : (s = i.getHeights(n),
            i.applyHeight(n, s))
    ...
    i.prototype.getHeights = function(t) {
        var i, n = t.data("equalizer"), s = n ? t.find("[" + this.attr + '-watch="' + n + '"]:visible') : t.find("[" + this.attr + "-watch]:visible");
        return s.height("inherit"),
        i = s.map(function() {
            return e(this).outerHeight(!1)
        }).get()
    }
    ,
    i.prototype.applyHeight = function(t, i) {
        var n = t.data("equalizer")
          , s = n ? t.find("[" + this.attr + '-watch="' + n + '"]:visible') : t.find("[" + this.attr + "-watch]:visible")
          , o = Math.max.apply(null, i);
        t.trigger("preEqualized.zf.Equalizer");
        for (var a = 0; a < s.length; a++)
            e(s[a]).css("height", o);
        t.trigger("postEqualized.zf.Equalizer")
    }
    ,
    i.prototype.destroy = function() {}
    ,
...
!function(t, e) {
    ...
    ,
    i.prototype._events = function() {
        e(window).on("resize.fndtn.interchange", t.util.throttle(this._reflow.bind(this), 50))
    }
    ,
    i.prototype._reflow = function() {
        var t;
    ...
    i.prototype._generateRules = function() {
        ...
        for (var n in t) {
            var s = t[n].slice(1, -1).split(", ")
              , o = s.slice(0, -1).join("")
              , a = s[s.length - 1];
            i.SPECIAL_QUERIES[a] && (a = i.SPECIAL_QUERIES[a]),
            e.push({
                path: o,
                query: a
            })
    ...
    i.prototype.replace = function(t) {
        if (this.currentPath !== t) {
            ...
            "IMG" === this.$element[0].nodeName ? this.$element.attr("src", t).load(function() {
                i.$element.trigger("replaced.zf.interchange"),
                i.currentPath = t
...
!function(t, e) {
    ...
    i.prototype._init = function() {
        ...
        t(document).find('[data-open="' + e + '"], [data-close="' + e + '"], [data-toggle="' + e + '"]').attr("aria-expanded", "false").attr("aria-controls", e),
    ...
    i.prototype.reveal = function(t) {
        ...
        t ? e.length && e.hide() : e.length && e.show()
    }
    ,
    i.prototype.open = function(i, n) {
        if (!this.$element.hasClass("is-open")) {
            ...
            e.Move(this.options.transitionTime, this.$element, function() {
                t("[data-off-canvas-wrapper]").addClass("is-off-canvas-open is-open-" + s.options.position),
                s.$element.addClass("is-open").attr("aria-hidden", "false").trigger("opened.zf.offcanvas")
            }),
            n && (this.$lastTrigger = n.attr("aria-expanded", "true")),
            this.options.autoFocus && this.$element.one("finished.zf.animate", function() {
...
!function(t, e) {
    ...
    i.prototype._events = function() {
        ...
        this.options.autoPlay && (this.$slides.on("click.zf.orbit", function() {
            i.$element.data("clickedOn", i.$element.data("clickedOn") ? !1 : !0),
    ...
    i.prototype.changeSlide = function(t, i, n) {
        ...
        o = i ? i : t ? this.options.infiniteWrap ? s.next("." + this.options.slideClass).length ? s.next("." + this.options.slideClass) : a : s.next("." + this.options.slideClass) : this.options.infiniteWrap ? s.prev("." + this.options.slideClass).length ? s.prev("." + this.options.slideClass) : r : s.prev("." + this.options.slideClass),
        o.length && (this.options.bullets && (n = n || this.$slides.index(o),
        this._updateBullets(n)),
        this.options.useMUI ? (e.Motion.animateIn(o.addClass("is-active").css({
            position: "absolute",
            top: 0
        ...
        e.Motion.animateOut(s.removeClass("is-active"), this.options["animOutTo" + d], function() {
            ...
            h.options.autoPlay && h.timer.restart()
...
!function(t, e) {
    ...
    i.prototype._init = function() {
        ...
        this.rules = t,
        e.isEmptyObject(t) || this._checkMediaQueries()
    }
    ,
    i.prototype._events = function() {
        var t = this;
...
!function(t, e) {
    ...
    ,
    i.prototype._events = function() {
        t(window).on("changed.zf.mediaquery", this._update.bind(this)),
        this.$toggler.on("click.zf.responsiveToggle", this.toggleMenu.bind(this))
    }
    ,
    i.prototype._update = function() {
        e.MediaQuery.atLeast(this.options.hideFor) ? (this.$element.hide(),
        this.$targetMenu.show()) : (this.$element.show(),
        this.$targetMenu.hide())
    }
    ,
    i.prototype.toggleMenu = function() {
        e.MediaQuery.atLeast(this.options.hideFor) || (this.$targetMenu.toggle(0),
...
!function(t, e) {
    ...
    i.prototype._setPosition = function(e) {
        ...
        "reveal full" === n ? this.$element.offset(t.Box.GetOffsets(this.$element, null, n, this.options.vOffset)).css({
            ...
            width: i.windowDims.width - 2 * this.options.hOffset
        }).offset(t.Box.GetOffsets(this.$element, null, "center", this.options.vOffset, this.options.hOffset)),
        this.changedSize = !0),
        e()
    }
    ,
    i.prototype.open = function() {
        ...
        this._setPosition(function() {
            ...
            i.options.animationIn ? i.options.overlay ? t.Motion.animateIn(i.$overlay, "fade-in", function() {
        ...
        e("body").addClass("is-reveal-open").attr({
    ...
    i.prototype._extraHandlers = function() {
        ...
        this.options.overlay || !this.options.closeOnClick || this.options.fullScreen || e("body").on("click.zf.reveal", function(t) {
            i.close()
        }),
        this.options.closeOnEsc && e(window).on("keydown.zf.reveal", function(e) {
            t.Keyboard.handleKey(e, i, {
                close: function() {
        ...
        this.$element.on("keydown.zf.reveal", function(n) {
            var s = e(this);
            t.Keyboard.handleKey(n, i, {
                tab_forward: function() {
                    this.$element.find(":focus").is(i.focusableElements.eq(-1)) && (i.focusableElements.eq(0).focus(),
                    n.preventDefault())
                },
                tab_backward: function() {
                    (this.$element.find(":focus").is(i.focusableElements.eq(0)) || this.$element.is(":focus")) && (i.focusableElements.eq(-1).focus(),
                    n.preventDefault())
                },
                open: function() {
                    i.$element.find(":focus").is(i.$element.find("[data-close]")) ? setTimeout(function() {
                        i.$anchor.focus()
                    }, 1) : s.is(i.focusableElements) && this.open()
                },
                close: function() {
                    this.options.closeOnEsc && (this.close(),
                    this.$anchor.focus())
    ...
    i.prototype.close = function() {
        ...
        this.changedSize && this.$element.css({
            height: "",
            width: ""
        }),
...
!function(t, e) {
    ...
    i.prototype._init = function() {
        ...
        this.$input2 = this.inputs.length ? this.inputs.eq(1) : t("#" + this.$handle2.attr("aria-controls")),
    ...
    i.prototype._setHandlePos = function(t, i, s, o) {
        ...
        var d = this
          ...
          , u = h ? "height" : "width"
          , c = h ? "top" : "left"
          , f = t[0].getBoundingClientRect()[u] / 2
        ...
        this.options.doubleSided) {
            var y, b = 0 === this.handles.index(t);
            this.handles.index(t);
            if (b)
                w[c] = (m > 0 ? 100 * m : 0) + "%",
                y = (100 * (n(this.$handle2.position()[c] + f, p) - parseFloat(m))).toFixed(this.options.decimal) + "%",
                w["min-" + u] = y,
                o && "function" == typeof o && o();
            else {
                var $ = parseFloat(this.$handle[0].style.left);
                i = (100 > i ? i : 100) - (isNaN($) ? this.options.end - i : $),
                w["min-" + u] = i + "%"
            }
        }
        ...
        e.Move(C, t, function() {
            t.css(c, v + "%"),
            d.options.doubleSided ? d.$fill.css(w) : d.$fill.css(u, 100 * m + "%")
        })
    }
    ,
    ...
    i.prototype._handleEvent = function(t, e, i) {
        ...
        if (i)
            ...
            var r = this.options.vertical
              ...
              , c = this.$element[0].getBoundingClientRect()[l]
              , f = this.$element.offset()[d] - h
              , p = f > 0 ? -u : -c > f - u ? c : Math.abs(f)
              , m = n(p, c);
            if (o = (this.options.end - this.options.start) * m,
            a = !1,
            !e) {
    ...
    i.prototype._events = function(i) {
        ...
        this.options.clickSelect && this.$element.off("click.zf.slider").on("click.zf.slider", function(t) {
            return s.$element.data("dragging") ? !1 : (s.animComplete = !1,
            void (s.options.doubleSided ? s._handleEvent(t) : s._handleEvent(t, s.$handle)))
        }),
...
!function(t, e) {
    ...
    i.prototype._init = function() {
        ...
        this.isStuck = !1,
        "" !== this.options.topAnchor ? this._parsePoints() : this.$anchor = t(this.options.anchor ? "#" + this.options.anchor : document.body),
    ...
    i.prototype._parsePoints = function() {
        for (var e = this.options.topAnchor, i = this.options.btmAnchor, n = [e, i], s = {}, o = 0, a = n.length; a > o && n[o]; o++) {
            var r;
    ...
    i.prototype._setSticky = function() {
        ...
        this.isStuck = !0,
        this.$element.removeClass("is-anchored is-at-" + i).addClass("is-stuck is-at-" + t).css(n).trigger("sticky.zf.stuckto:" + t)
    }
    ,
    ...
    i.prototype._setSizes = function(t) {
        this.canStick = e.MediaQuery.atLeast(this.options.stickyOn),
        this.canStick || t();
    ...
    i.prototype._setBreakPoints = function(t, e) {
        ...
        a -= t + i) : "bottom" === this.options.stickTo && (o -= r - (t + s),
        a -= r - s),
        this.topPoint = o,
        this.bottomPoint = a,
        e && e()
...
!function(t, e) {
    ...
    i.prototype._events = function() {
        ...
        this.options.matchHeight && t(window).on("changed.zf.mediaquery", this._setHeight.bind(this))
    }
    ,
    ...
    i.prototype._addKeyHandler = function() {
        var i = this;
        i.$element.find("li:first-of-type"),
        i.$element.find("li:last-of-type");
        this.$tabTitles.off("keydown.zf.tabs").on("keydown.zf.tabs", function(n) {
            if (9 !== n.which) {
                ...
                var s, o, a = t(this), r = a.parent("ul").children("li");
                r.each(function(e) {
                    return t(this).is(a) ? void (i.options.wrapOnKeys ? (s = 0 === e ? r.last() : r.eq(e - 1),
                    o = e === r.length - 1 ? r.first() : r.eq(e + 1)) : (s = r.eq(Math.max(0, e - 1)),
                    o = r.eq(Math.min(e + 1, r.length - 1)))) : void 0
                }),
                e.Keyboard.handleKey(n, i, {
                    open: function() {
                        a.find('[role="tab"]').focus(),
                        i._handleTabChange(a)
                    },
                    previous: function() {
                        s.find('[role="tab"]').focus(),
                        i._handleTabChange(s)
                    },
                    next: function() {
                        o.find('[role="tab"]').focus(),
                        i._handleTabChange(o)
                    }
                })
            }
        })
...
!function(t, e) {
    ...
    function i(n, s) {
        this.$element = n,
        this.options = e.extend({}, i.defaults, n.data(), s),
        this.className = "",
        this._init(),
        this._events(),
        t.registerPlugin(this)
...
!function(t, e, i) {
    ...
    n.prototype._setPosition = function() {
        ...
        if (e.width >= e.windowDims.width || !this.counter && !i.Box.ImNotTouchingYou(this.template))
            return this.template.offset(i.Box.GetOffsets(this.template, this.$element, "center bottom", this.options.vOffset, this.options.hOffset, !0)).css({
    ...
    n.prototype.show = function() {
        if ("all" !== this.options.showOn && !i.MediaQuery.atLeast(this.options.showOn))
            return !1;
        var t = this;
    ...
    n.prototype._events = function() {
        ...
        this.$element.on("focus.zf.tooltip", function(i) {
            return e = !0,
            console.log(t.isClick),
            t.isClick ? !1 : void t.show()
