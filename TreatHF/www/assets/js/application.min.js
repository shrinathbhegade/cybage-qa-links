(function(window) {
    ...
    acc.notificationUrl = "https://stage.tools.acc.org/ACCUtility.Web/Notification";
...
(function(w, UtilFuns, AppModel, ko, $) {
    ...
    ViewModel.prototype.init = function() {
        ...
        this.databind.onClick = function(data, event) {
            ...
            } else if (data.type == "EVALUATION_CLICK") {
                var el = event.currentTarget;
            } else if (data.type == "ADVICE_EVALUATION_CLICK") {} else if (data.type == "EVALUATE_WARNING_HANDLER") {
                that.onDisableAdviceClick(data);
            } else if (data.type == "DRUG_REFERAENCE_CLICK") {} else if (data.type == "SCROLL_DOWN") {
                if (!window.appResetting) $("html,body").stop().animate({
