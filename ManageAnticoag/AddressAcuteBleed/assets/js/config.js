...
// var baseUrl = 'https://stage.tools.acc.org/ManageAnticoag/AddressAcuteBleed/emailresult.html#!/content/';
var applicationBaseUrl = 'https://tools.stage.acc.org/ManageAnticoag';
var baseUrl = applicationBaseUrl+'/AddressAcuteBleed/emailresult.html#!/content/';
var deviceTypes = {
    Web: "Web"
    , Mobile: "Mobile"
};
