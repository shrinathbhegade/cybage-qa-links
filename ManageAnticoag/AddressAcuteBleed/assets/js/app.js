/*!
App JS
Copyright © 2017-2018 Cybage Software Pvt. Ltd
...
var equalizeAdviceButtons = function() {
    var difference = $("#oacrestartbtn").height() - $("#backButton").height();
    var newPadding = parseInt($("#oacrestartbtn").css('padding-top')) + difference / 2;
    $("#backButton").css("padding-top", newPadding);
    $("#backButton").css("padding-bottom", newPadding);
}