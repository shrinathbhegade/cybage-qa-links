...
(function () {
    ...
    var F = z
            ...
            ba(a, function () {
                for (var b = 0, c = l(String(F)).split("."), d = l(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                    ...
                    do {
                        h = /(\d*)(\D*)(.*)/.exec(h) || ["", "", "", ""];
                        g = /(\d*)(\D*)(.*)/.exec(g) || ["", "", "", ""];
                        if (0 == h[0].length && 0 == g[0].length) break;
                        b = m(0 == h[1].length ? 0 : parseInt(h[1], 10), 0 == g[1].length ? 0 : parseInt(g[1], 10)) || m(0 == h[2].length, 0 == g[2].length) || m(h[2], g[2]);
                        h = h[3];
                        g = g[3]
                    } while (0 == b)
                }
        ...
        , fa;
    var ha = k.document;
    fa = ha && v ? y() || ("CSS1Compat" == ha.compatMode ? parseInt(F, 10) : 5) : void 0;
    var I;
    if (!(I = !w && !v)) {
        var J;
        if (J = v) J = 9 <= Number(fa);
        I = J
    }
    I || w && H("1.9.1");
    v && H("9");
    ...
    var K = window
        ...
        , N = function () {
            var a;
            if ((a = Object.create) && ka.test(a)) a = a(null);
            else {
                a = {};
    ...
    var ta = /^(\/[a-zA-Z0-9_\-]+)+$/
        ...
        , Ba = function (a, b, c, d) {
            var e = a.split(";")
                ...
                , h = sa[f]
                , g = null;
            h ? g = h(e, b, c, d) : X("no hint processor for: " + f);
            g || X("failed to generate load url");
            b = g;
            c = b.match(ya);
            (d = b.match(za)) && 1 === d.length && Aa.test(b) && c && 1 === c.length || X("failed sanity: " + a);
            return g
        }
        , Ea = function (a, b, c, d) {
            a = Ca(a);
            wa.test(c) || X("invalid_callback");
            b = Da(b);
            d = d && d.length ? Da(d) : null;
            var e = function (a) {
        ...
        , Ca = function (a) {
            "/" !== a.charAt(0) && X("relative path");
            for (var b = a.substring(1).split("/"), c = []; b.length;) {
                a = b.shift();
                if (!a.length || 0 == a.indexOf(".")) X("empty/relative directory");
                else if (0 < a.indexOf("=")) {
                    b.unshift(a);
                    break
                }
            ...
            for (var d = 0, e = b.length; d < e; ++d) {
                ...
                2 == f.length && h && g && (a[h] = a[h] || g)
            }
            b = "/" + c.join("/");
            ta.test(b) || X("invalid_prefix");
            c = 0;
            for (d = ua.length; c < d; ++c) ua[c].test(b) && X("invalid_prefix");
            c = Y(a, "k", !0);
            d = Y(a, "am");
            e = Y(a, "rs");
            a = Y(a, "t");
    ...
    sa.m = function (a, b, c, d) {
        ...
        return "https://apis.google.com" + Ea(a, b, c, d)
    };
    var Z = decodeURI("%73cript")
        ...
        , Ia = function () {
            var a = P.nonce;
            if (void 0 !== a) return a && a === String(a) && a.match(Ga) ? a : P.nonce = null;
            var b = M(P, "us", []);
            if (!b || !b.length) return P.nonce = null;
            for (var c = L.getElementsByTagName(Z), d = 0, e = c.length; d < e; ++d) {
                var f = c[d];
                if (f.src && (a = String(f.nonce || f.getAttribute("nonce") || "") || null)) {
                    for (var h = 0, g = b.length; h < g && b[h] !== f.src; ++h);
                    if (h !== g && a && a === String(a) && a.match(Ga)) return P.nonce = a
                }
            }
            return null
        }
        , Ka = function (a) {
            if ("loading" != L.readyState) Ja(a);
            else {
                var b = Ia()
                    , c = "";
                null !== b && (c = ' nonce="' + b + '"');
                L.write("<" + Z + ' src="' + encodeURI(a) + '"' + c + "></" + Z + ">")
            }
        }
        , Ja = function (a) {
            ...
            b.async = "true";
            (a = L.getElementsByTagName(Z)[0]) ? a.parentNode.insertBefore(b, a): (L.head || L.body || L.documentElement).appendChild(b)
        }
        , La = function (a, b) {
            var c = b && b._c;
            if (c)
        ...
        , Pa = function (a, b) {
            ...
            if (e["::"] && b.length) {
                ...
                for (var f = null; f = b.shift();) {
                    var h = f.split(".");
                    h = e[f] || e[h[1] && "ns:" + h[0] || ""] || d;
                    var g = a.length && a[a.length - 1] || null
                        , x = g;
                    g && g.hint == h || (x = {
                        hint: h
                        , b: []
        ...
        , Oa = function (a, b, c) {
            ...
            var d = b.callback
                ...
                , g = b.onerror
                , x = void 0;
            "function" == typeof g && (x = g);
            var A = null
                , B = !1;
            if (f && !h || !f && h) throw "Timeout requires both the timeout parameter and ontimeout parameter to be set";
            g = M(Q(c), "r", []).sort();
            var S = M(Q(c), "L", []).sort()
                , G = [].concat(g)
                , qa = function (a, b) {
                    ...
                    K.clearTimeout(A);
                    S.push.apply(S, q);
                    var d = ((O || {}).config || {}).update;
                    d ? d(e) : e && M(P, "cu", []).push(e);
                    if (b) {
                        V("me0", a, G);
                        try {
                            Na(b, c, x)
            ...
            if (q.length) {
                ...
                if (q.length) {
                    ...
                    g.push.apply(g, q);
                    V("ml0", q, G);
                    b.sync || K.___gapisync ? Ka(a) : Ja(a)
                }
                else t[u](ja)
            }
            else qa(q) && d && d()
    ...
    oa.bs0 = window.gapi._bs || (new Date).getTime();
    U("bs0");
    oa.bs1 = (new Date).getTime();
    U("bs1");
...
gapi.load("client", {
    ...
    , _c: {
        "jsl": {
            ...
            , "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.rzM2fB_ZykU.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCNGjA-NjXRlcble1WbaK_BYhavOHg"
            , "u": "https://apis.google.com/js/client.js"
            , "hee": true
            , "fp": "e0f6c2f87144ea643a2c1239b38ab058d56c108b"
            , "dpo": false
        }
        , "fp": "e0f6c2f87144ea643a2c1239b38ab058d56c108b"
