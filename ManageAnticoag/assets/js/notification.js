...
var _notification = function () {
    var self = this;
    var criticalKey = "BAV2Critical",
        nonCriticalKey = "BAV2NonCritical";
    var appStoreURLS = {
        '1': "https://itunes.apple.com/us/app/bridgeanticoag/id1158887101?mt=8",
        '2': "https://play.google.com/store/apps/details?id=org.acc.BridgeAnticoag"
    }
    self.showCritical = true;
    self.webApiUrl = 'https://tools.stage.acc.org/ACCUtility.Web/';
    self.appId = 'org.acc.bridgeanticoag';
...
/*var NotificationTester = function(notiObject) {
    var self = this;
    notiObject.webApiUrl = "http://172.27.216.69:8082/";
}

var tester = new NotificationTester(notification);*/
