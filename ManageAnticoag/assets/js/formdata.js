var formdata = {
    prescribingDrugsInfo: [
		{drug: "Apixaban", url: "https://packageinserts.bms.com/pi/pi_eliquis.pdf"},
		{drug: "Betrixaban", url: "https://www.accessdata.fda.gov/drugsatfda_docs/label/2017/208383s001lbl.pdf"},
        {drug: "Dabigatran", url: "https://docs.boehringer-ingelheim.com/Prescribing%20Information/PIs/Pradaxa/Pradaxa.pdf"},
        {drug: "Edoxaban", url: "http://dsi.com/prescribing-information-portlet/getPIContent?productName=Savaysa&inline=true"},
        {drug: "Rivaroxaban", url: "http://www.janssenlabels.com/package-insert/product-monograph/prescribing-information/XARELTO-pi.pdf"},
        {drug: "Warfarin", url: "https://packageinserts.bms.com/pi/pi_coumadin.pdf"},
        {drug: "4F-PCC", url: "http://labeling.cslbehring.com/PI/US/Kcentra/EN/Kcentra-Prescribing-Information.pdf"},
        {drug: "aPCC", url: "https://www.shirecontent.com/PI/PDFs/FEIBA_USA_ENG.pdf"},
        {drug: "Idarucizumad", url: "http://docs.boehringer-ingelheim.com/Prescribing%20Information/PIs/Praxbind/Praxbind.pdf"},
        {drug: "Andexanet alfa", url: "https://www.fda.gov/media/113279/download"}
    ]
	/*sex:[
		{text:"Male", value:"1"},
